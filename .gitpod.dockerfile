...
RUN echo "include /workspace/api/gitpod_config/apache/apache.conf" > /etc/apache2/apache2.conf
RUN echo ". /workspace/api/gitpod_config/apache/envvars" > /etc/apache2/envvars

RUN echo "!include /workspace/api/gitpod_config/mysql/mysql.cnf" > /etc/mysql/my.cnf
